...
<div id="picture" class="tabcontent">
    ...
    <p class="createdwith">Maps created with <a href="https://www.openstreetmap.org/#map=12/{{COORDINATES}}">OpenStreetMap</a> from {{MAP_DATE}}</p>
</div>
...
<p class="creation_date">created on: {{CREATION_DATE}}</p>
<script>
